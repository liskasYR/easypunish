<div align="center">
  ...
  <p>EasyPunish is a moderation plugin built to make server moderation fast and organized. Instead of dealing with messy commands and lost punishment times, EasyPunish gives every punishment a unique 6-digit ID, includes full GUI menus for staff, integrates directly with LuckPerms for voice-chat mutes, and lets players appeal their punishments directly in-game.</p>
</div>
